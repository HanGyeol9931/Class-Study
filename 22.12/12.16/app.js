...
// 자바스크립트 콘솔에서 miner.start(1); 이렇게 실행을 시켰는데
...
"id" : 1, "method" : "miner_start", "params" : [1]}' localhost:9000
*/ 

// 마이닝 사이트 만들어 보기

// 지금까지 만든거에서 접속중인 계정을 가져와서 
// 접속중인 계정이 블록 마이닝을 해서 채굴하고 
// 실시간으로 잔액 보여주는 UI 만들기
// 계정 주소를 직접 입력해서 해도 괜찮고 
// 아니면 메타마스크를 이용해서 접속중인 계쩡으로 세팅해도 괜찮고.

// 서버에 요청할때 객체의 속성

// 요청할때
/*
    id : 요청 아이디를 지정하고 서버에서 응답받을떄 구별하려고 사용
    params : 서버에 전달 객체
