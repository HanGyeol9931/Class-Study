...
// node_modules파일도 생겼는데 npm 설치를 하니깐 이 폴더안에 설치되어 있는
// .bin폴더를 제외하고 다른 폴더들은 현재 프로젝트가 의존하는 있는 패키지들
...
// .vscode폴더를 만들고 안에 sttings.json을 만들어 준다
// 이곳에 설정한 이유는 개인이 사용하는 vscode 설정 말고 프로젝트 단위로
// 설정을 적용 시킬수 있다.
// 팀이나 회사에서 작업을 하면서 여러명이 작업 할때 설정 값을 미리 정해놓고
// 적업을 시작하면 병합시 충돌을 덜어준다. 사수한테 이쁨받음
...
// 클래스가 두개 있다고 가정을 하면 두 클래스의 관계성
// 그냥 쓸려고 패키지 다운받은다고 보면 된다.
