...
// node.js를 설치해서 실행한다고 웹서버가 실행되는게 아니고 node.js에 있는 라이브러리를 설치해서
...
// 2. 구글에서 개발한 js엔진을 쓰기 떄문에 속도가 빠르다.(인터프린터 방식)

// 3. 논 블로킹 방식 node,js의 모든 API는 비동기적으로 작동하며 호출 후 다른 API를 바로 불러올수 있다.
