...
// 블록 헤더를 만들 클래스
class Header {
    constructor(_height,_previusHash){
        // 블록의 버전
        ...
        // 이전 블록의 해시값
        // 최초 블록은 이전 블록의 해시값이 없으니 0으로 만들어진 문자열을 넣어준다.
        this.previusHash = _previusHash || "0".repeat(64);
    }
...
class Block {
    constructor(_header,_data){
        ...
        this.previusHash = _header.previusHash;
        this.data =_data;
